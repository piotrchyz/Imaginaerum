...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio_ray">
        ...
        <xsl:attribute name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray"  select="$ptn:Coordinate_X__x3A__generated + ($ptn:Coordinate_X__x3A__generated - (((($ptn:Coordinate_X__x3A__max - $ptn:Coordinate_X__x3A__min) div 2 * 3) )  ) ) * $ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio"/>
        <xsl:attribute name="ptn:Coordinate_Y__x3A__fieldOfView__x3A__ray" select="$ptn:Coordinate_Y__x3A__generated + ($ptn:Coordinate_Y__x3A__generated - (((($ptn:Coordinate_Y__x3A__max - $ptn:Coordinate_Y__x3A__min) div 2 * 3) )  ) ) * $ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio"/>
            ...
            <xsl:for-each select="$ptn:Receptor__x3A__generate/ptn:Coordinate_Y/@ptn:Coordinate_Y__x3A__generate__min to $ptn:Receptor__x3A__generate/ptn:Coordinate_Y/@ptn:Coordinate_Y__x3A__generate__max">
                ...
                <ptn:Receptor>
                    <xsl:call-template name="ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio_ray">
                        <xsl:with-param name="ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio"  select="0.1"/>
                        ...
                        <xsl:with-param name="ptn:Coordinate_X__x3A__generated" select="$ptn:Coordinate_X__x3A__generated__separator"/>
                        ...
                        <xsl:with-param name="ptn:Coordinate_Y__x3A__generated" select="$ptn:Coordinate_Y__x3A__generated__separator"/>
