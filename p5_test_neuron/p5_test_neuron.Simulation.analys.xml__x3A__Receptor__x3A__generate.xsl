...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio_ray">
        ...
        <xsl:variable name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff" select="($ptn:Coordinate_X__x3A__max - $ptn:Coordinate_X__x3A__min ) div 2"/>
        
        <xsl:variable name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff2" select="$ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff * 3"/>
        
        <xsl:variable name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff3" select="$ptn:Coordinate_X__x3A__generated__separator - $ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff2 - ( $ptn:Coordinate_X__x3A__min div 2 )"/>
        
        <xsl:if test="$ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio_ray__X3A__debug = true()">
            <xsl:attribute name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff"  select="$ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff"/>
            <xsl:attribute name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff2"  select="$ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff2"/>
            <xsl:attribute name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff3" select="$ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff3"/>
        </xsl:if>
        <xsl:attribute name="ptn:Coordinate_X__x3A__fieldOfView__x3A__ray"  select="$ptn:Coordinate_X__x3A__generated__separator + $ptn:Coordinate_X__x3A__fieldOfView__x3A__ray.diff3"/>
    ...
    <xsl:template mode="ptn:Simulation.analys.xml__x3A__Receptor__x3A__generate" match="ptn:Receptor__x3A__generate[@ptn:Receptor__x3A__generate__fieldOfView__x3A__ratio][ptn:Coordinate_X[@ptn:Coordinate_X__x3A__generate__min]][ptn:Coordinate_X[@ptn:Coordinate_X__x3A__generate__separator]]" >
        ...
        <xsl:for-each select="$ptn:Coordinate_X__x3A__generate__min to $ptn:Coordinate_X__x3A__generate__max">
            ...
            <xsl:for-each select="$ptn:Receptor__x3A__generate/ptn:Coordinate_Y/@ptn:Coordinate_Y__x3A__generate__min to $ptn:Receptor__x3A__generate/ptn:Coordinate_Y/@ptn:Coordinate_Y__x3A__generate__max">
                ...
                <ptn:Receptor ptn:Coordinate_X__x3A__generated="{$ptn:Coordinate_X__x3A__generated}"
