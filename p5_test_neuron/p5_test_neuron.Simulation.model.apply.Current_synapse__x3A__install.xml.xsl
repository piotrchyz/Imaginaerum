...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install"
        ...
        <xsl:comment>#30[LP[<xsl:value-of select="@ptn:Simulated_potential__x3A__less_charged_node"/>]] [MP[<xsl:value-of select="@ptn:Simulated_potential__x3A__more_charged_node"/>]]</xsl:comment>
        <xsl:choose>
            <xsl:when test="number(@ptn:Simulated_potential__x3A__diff) &lt; 0">
                <xsl:comment>#32 bypassed due to number(@ptn:Simulated_potential__x3A__diff) &lt; 0</xsl:comment>
            </xsl:when>
            <xsl:otherwise>
                <xsl:apply-templates mode="#current">
    ...
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" 
        ...
        <xsl:param name="ptn:Label"  tunnel="yes" required="yes"/>
        <xsl:param name="ptn:Defaults" tunnel="yes" required="yes"/>
        <xsl:param name="ptn:Output_Node__x3A__attract" required="yes" tunnel="yes"/>
        <xsl:param name="ptn:Label__x3A__attract" required="yes" tunnel="yes"/>
        <xsl:param name="ptn:Label__x3A__context" required="yes" tunnel="yes"/>
        <xsl:choose>
    ...
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install"
        match="ptn:Simulation.attract__x3A__calculate__x3A__output_node__x3A__not_validated|ptn:Simulation.Stress__x3A__calculate__x3A__output_node__x3A__not_validated">
    ...
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" match="ptn:Input__x3A__nodes__x3A__prohibit"/>
    
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" match="ptn:Simulation.attract__x3A__calculate__x3A__ignored|ptn:Simulation.Stress__x3A__calculate__x3A__output_node__x3A__not_validated"/>
    ...
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" match="ptn:Label|ptn:Coordinate_X|ptn:Coordinate_Y|ptn:Coordinate_Z"/>
    
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" match="ptn:Capacitance|ptn:Resistance|ptn:Minimum_voltage|ptn:Maximum_voltage|ptn:Resting_potential|ptn:Reset_potential|ptn:Firing_threshold"/>    
    <xsl:template mode="ptn:Simulation.attract__x3A__calculate.best.unique__x3A__Current_synapse__x3A__install" match="ptn:Refactory_period|ptn:Is_inhibitor|ptn:Simulated_potential"/>
