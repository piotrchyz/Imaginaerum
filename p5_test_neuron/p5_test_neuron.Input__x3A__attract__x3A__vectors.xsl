    ...
    <xsl:template name="ptn:Input__x3A__attract__x3A__vectors__x3A__calculate">
        ...
        <ptn:Input__x3A__attract__x3A__vectors__x3A__calculate 
            ...
            <xsl:choose><!-- p5suis:say.PL="Tworzę obliczenia pozycji dla węzła zależnego od {$ptn:Input__x3A__nodes//ptn:Input__x3A__node}" -->
                ...
                <xsl:when test="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]) = 3 and not($ptn:Leaky_neuron_inhibitor__x3A__AB) and not($ptn:Leaky_neuron_inhibitor__X3A__AA) and $ptn:Leaky_neuron_standard and $ptn:Simulation.attract__x3A__calculate">
                    <xsl:comment>#39-50 [cnt[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>]]   cnt2[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//*[ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]])"/>]</xsl:comment>
                    <xsl:call-template name="ptn:Coordinate_X__x3A__Input__X3A__attract__x3A__vector__x3A__calculate">
                        <xsl:with-param name="ptn:Coordinate_X__x3A__Input__X3A__attract__x3A__vector__x3A__calculate.offset" select="0.7" tunnel="yes"/>
                    ...
                    <xsl:call-template name="ptn:Coordinate_Y__x3A__Input__X3A__attract__x3A__vector__x3A__calculate">
                        <xsl:with-param name="ptn:Coordinate_Y__x3A__Input__X3A__attract__x3A__vector__x3A__calculate.increment" select="13" tunnel="yes"/>
                    </xsl:call-template>
                    <xsl:call-template name="ptn:Coordinate_Z__x3A__Input__X3A__attract__x3A__vector__x3A__calculate"/>
                ...
                <xsl:when test="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]) = 2 and not($ptn:Leaky_neuron_inhibitor__x3A__AB) and not($ptn:Leaky_neuron_inhibitor__X3A__AA) and $ptn:Leaky_neuron_standard and $ptn:Simulation.attract__x3A__calculate">
                            <xsl:comment>#39-55 [cnt[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>]]   cnt2[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//*[ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]])"/>]</xsl:comment>
                            <xsl:call-template name="ptn:Coordinate_X__x3A__Input__X3A__attract__x3A__vector__x3A__calculate">
                        ...
                        <xsl:when test="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]) = 1 and $ptn:Leaky_neuron_inhibitor__x3A__AB">
                            <xsl:comment>#39-71 [cnt[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>]]   cnt2[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//*[ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]])"/>]</xsl:comment>
                            <xsl:call-template name="ptn:Coordinate_X__x3A__Input__X3A__attract__x3A__vector__x3A__calculate">
                ...
                <xsl:when test="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]) = 1 and $ptn:Leaky_neuron_inhibitor__X3A__AA">
                    <xsl:comment>#39-83 [cnt[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>]]   cnt2[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//*[ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ]])"/>]</xsl:comment>
                    <xsl:call-template name="ptn:Coordinate_X__x3A__Input__X3A__attract__x3A__vector__x3A__calculate">
                    ...
                    <xsl:call-template name="ptn:Coordinate_Z__x3A__Input__X3A__attract__x3A__vector__x3A__calculate"/>
                          ...
                          <xsl:otherwise>
                              <xsl:message terminate="yes">#20 [Not implemented] only signle input now. [SimulAttract[<xsl:value-of select="$ptn:Simulation.attract__x3A__calculate"/>]] [$nI S[<xsl:value-of select="$ptn:Leaky_neuron_standard"/>] AB[<xsl:value-of select="$ptn:Leaky_neuron_inhibitor__x3A__AB"/>] AA[<xsl:value-of select="$ptn:Leaky_neuron_inhibitor__X3A__AA"/>]] [#[Input[<xsl:value-of select="count($ptn:Input__x3A__nodes//ptn:Input__x3A__node)"/>]]]  [# Stress[<xsl:value-of select="count($ptn:Stress__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>] Attr[<xsl:value-of select="count($ptn:Attract__x3A__flag.nodes//ptn:Label[ text() =  $ptn:Input__x3A__nodes//ptn:Input__x3A__node/text() ])"/>]]</xsl:message>
                          </xsl:otherwise>
                      </xsl:choose>
