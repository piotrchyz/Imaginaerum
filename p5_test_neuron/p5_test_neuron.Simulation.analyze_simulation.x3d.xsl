...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="p5_test_neuron.Simulation.analyze_simulation.x3d.section.xsl"/>
    
    <xsl:include href="p5_test_neuron.Simulation.analyze_simulation.x3d.generate__x3A__pattern.xsl"/>
